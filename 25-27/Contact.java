...
public class Contact
{
    ...
    public String getSecretInfo(String pwd)
    {
    	...
    	if(pwd.equals(password)) // ah yes very good password storage you have here, it's just a string
    	{
    		info = secretInfo;
    	}
    ...
    public boolean isSamePerson(Contact person) // nice,
    {
    	boolean same=false;
